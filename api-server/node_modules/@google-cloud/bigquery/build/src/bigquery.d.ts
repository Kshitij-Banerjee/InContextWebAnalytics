...
import { Dataset, DatasetOptions } from '@google-cloud/bigquery/build/src/dataset';
import { Job, JobOptions, QueryResultsOptions } from '@google-cloud/bigquery/build/src/job';
import { Table, TableField, TableSchema, TableRow, JobCallback, JobResponse, RowMetadata } from '@google-cloud/bigquery/build/src/table';
import { RetryOptions } from '@google-cloud/common/build/src/util';
import bigquery from '@google-cloud/bigquery/build/src/types';
import { setLogFunction } from '@google-cloud/bigquery/build/src/logger';
export { common };
